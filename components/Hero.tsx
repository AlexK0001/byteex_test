          ...
          <div className="flex items-start justify-between gap-8">
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <div className="flex items-center gap-3 flex-wrap">
                      <span style={{ fontFamily: "var(--font-display)", fontSize: "15px", lineHeight: "23px", letterSpacing: "0.03em", color: "#676869" }}>
                        {content.reviewerName}
                      </span>
                      <StarRating count={4} />
                      <span style={{ fontFamily: "var(--font-body)", fontSize: "11px", lineHeight: "20px", letterSpacing: "0.02em", color: "#828282" }}>
                        {content.reviewCount}
                      </span>
                    </div>
                  </div>
                </div>
                <p style={{ fontFamily: "var(--font-body)", fontSize: "12px", lineHeight: "23px", letterSpacing: "0.04em", color: "#676869" }}>
                  {content.reviewText}
                </p>
              </div>
            </div>
            ...
            <div className="hidden lg:block relative flex-shrink-0" style={{ width: "535px", height: "500px" }}>
              <div className="absolute" style={{ left: "122px", top: "0" }}>
                <Image src="https://images.unsplash.com/photo-1617952739396-2e6a0a9c1a32?w=391&h=445&fit=crop" alt="Loungewear collection" width={391} height={445} className="rounded-[8px] object-cover" priority />
              </div>
              <div className="absolute" style={{ left: "0", top: "40px" }}>
                <Image src="https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=158&h=300&fit=crop" alt="Loungewear model" width={158} height={300} className="rounded-[8px] object-cover" />
              </div>
              <div className="absolute" style={{ left: "75px", top: "56px", border: "4px solid white" }}>
                <Image src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=220&h=316&fit=crop" alt="Featured loungewear" width={220} height={316} className="rounded-[4px] object-cover shadow-card" />
              </div>
              <div className="absolute flex gap-2" style={{ left: "75px", top: "385px" }}>
                {[
                  ...
                  <Image key={i} src={src} alt={`Variant ${i + 1}`} width={75} height={75} className="rounded-[4px] object-cover" />
                ))}
              </div>
              <div className="absolute" style={{ right: "0", top: "0" }}>
                <Image src="https://images.unsplash.com/photo-1618932260643-eee4a2f652a6?w=116&h=225&fit=crop" alt="Loungewear style" width={116} height={225} className="rounded-[8px] object-cover" />
              </div>
              <div className="absolute" style={{ right: "0", top: "235px" }}>
                <p style={{ fontFamily: "var(--font-body)", fontSize: "13px", lineHeight: "22px", letterSpacing: "0.03em", color: "#676869", textAlign: "center" }}>
                  White Robe
                </p>
