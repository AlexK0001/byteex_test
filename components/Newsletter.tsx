...
const PRODUCT_CARDS = [
  {
    src: "https://images.unsplash.com/photo-1554568218-0f1715e72254?w=260&h=373&fit=crop",
    label: "Ships in 1-2 Days",
    title: "Cozy Set",
  },
  {
    src: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=260&h=373&fit=crop",
    label: "Ships in 1-2 Days",
    title: "White Robe",
  },
  {
    src: "https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=260&h=373&fit=crop",
    label: "Ships in 1-2 Days",
    title: "Jogger Set",
  },
];

export default function Newsletter({ headline, subtext }: NewsletterProps) {
  return (
    <section className="py-[80px] px-6 md:px-[96px] bg-white relative overflow-hidden">
      {/* Cream gradient bottom */}
      <div
        className="absolute bottom-0 left-[1px] pointer-events-none"
        style={{
          width: "1676px",
          height: "508px",
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span style={{ fontFamily: "var(--font-body)", fontSize: "14px", letterSpacing: "0.03em", color: "#676869" }}>
