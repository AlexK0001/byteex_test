  ...
  <section className="feat" id="shop">
    <div className="wrap">
      ...
      <div className="feat__grid">
        ...
        {/* Product image */}
        <div className="feat__imgcol">
          <div style={{ position:"relative" }}>
            <button className="arrow" style={{ position:"absolute",left:-28,top:"50%",transform:"translateY(-50%)",zIndex:2 }} aria-label="prev">
            ...
            <div className="feat__main-img" style={{ borderRadius:8, overflow:"hidden", width:"100%", maxWidth:429, height:560 }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=429&h=560&fit=crop&auto=format"
                alt="White Robe" style={{ width:"100%", height:"100%", objectFit:"cover", display:"block" }} />
            </div>
            <button className="arrow" style={{ position:"absolute",right:-28,top:"50%",transform:"translateY(-50%)",zIndex:2 }} aria-label="next">
